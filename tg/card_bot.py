...
bot = TeleBot(token='5765397407:AAEqRjlaCTzSlGG-EUm2E6aON8mZjx8dMVA', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я могу сгенерировать для тебя банковскую карту\nКакая карта тебе нужна?', # текст сообщения
